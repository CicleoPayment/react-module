                ...
                <div className="cap-shadow-lg cap-alert cap-alert-warning">
                    <div>
                        ...
                        <span>
                            ...
                            account, swap your native tokens to ERC20 tokens to
                            continue
                        </span>
                    </div>
                </div>
        ...
        <>
            ...
            <div className="cap-flex cap-flex-col cap-p-3 cap-px-6 cap-font-medium cap-space-y-6">
                <span className="cap-font-semibold ">
                    You can choose to pay with any of the ERC20 tokens below,
                    but be advised that the amount of tokens used to make the
                    payment will be equal to {subscription.price}{" "}
                    {subscription.tokenSymbol} in value. The amount of tokens
                    equal to {subscription.price} {subscription.tokenSymbol} is
                        ...
                        {coinLists.map((coin, index) => (
                            ...
                            >
                                ...
                                <div className="cap-flex cap-flex-col cap-items-end cap-text-right">
                                    ...
                                    {BigNumber.from(coin.raw_amount_hex_str).lt(
                                        coin.toPay.toString()
                                    ) && (
