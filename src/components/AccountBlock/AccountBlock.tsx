        ...
        <>
            ...
            {subscription.id == 0 ? (
                ...
                <div className="cap-flex">
                    ...
                    <div className="cap-p-4 cap-space-y-6 cap-flex-grow">
                        <div>
                    ...
                    <div className="cap-p-4 cap-space-y-3 cap-flex-grow">
                        <span className=" cap-font-semibold">
                            Subscription Info
                        </span>
                        <div className="cap-divider"></div>
...
const SubscriptionSquare: FC<SubscriptionSquare> = ({
    ...
    return (
        <div className=" cap-flex cap-flex-col cap-p-4 cap-space-y-6">
            <div>
                <span className="cap-text-base cap-font-bold">
            ...
            >
                ...
                <div className="cap-relative cap-bg-white cap-rounded-lg cap-shadow dark:cap-bg-gray-700">
                    <form action="" onSubmit={handleSubmit}>
                        {/* <!-- Modal header --> */}
                        <div className="cap-flex cap-items-start cap-justify-between cap-p-4 cap-rounded-t dark:cap-border-gray-600">
