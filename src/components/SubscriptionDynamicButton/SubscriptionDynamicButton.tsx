...
import "./SubscriptionDynamicButton.css";
...
const SubscriptionDynamicButton: FC<SubscriptionDynamicButton> = ({
    subManagerId,
    chainId,
    name,
    price,
    ...
    const getSwap = async () => {
        ...
        if (isBridged) {
            ...
            setApprovalSubscription(
                Number(ethers.utils.formatUnits(price, coin.decimals))
            );
        ...
        setApprovalSubscription(
            Number(ethers.utils.formatUnits(price, subManager.decimals))
        );

        const priceFormatted = Number(
            ethers.utils.formatUnits(price, coin.decimals)
        );
            ...
            <div className="cap-modal cap-modal-bottom sm:cap-modal-middle !cap-ml-0">
                <div className="cap-modal-box cap-relative cap-p-0 cap-text-white">
                    ...
                    {(() => {
                        ...
                        if (subscriptionInfoIsFetched == false)
                            return (
...
export default SubscriptionDynamicButton;
